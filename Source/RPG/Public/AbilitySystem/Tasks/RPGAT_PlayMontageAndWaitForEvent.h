 ...
 */
UCLASS()
class RPG_API URPGAT_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()

public:

	URPGAT_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	UFUNCTION(BlueprintCallable , Category = "RPG|Ability|Tasks" , meta = (HidePin = "OwningAbility" , DefaultToSelf = "OwningAbility" , BlueprintInternalUseOnly = "TRUE"))
	static URPGAT_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
